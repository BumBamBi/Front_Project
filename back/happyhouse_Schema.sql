...
CREATE TABLE IF NOT EXISTS `happyhouse`.`board` (
  ...
  PRIMARY KEY (`no`),
  INDEX `fk_board_member1_idx` (`author` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `happyhouse`.`star_location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `happyhouse`.`star_location` (
  `no` INT NOT NULL AUTO_INCREMENT,
  `baseaddress_no` INT NOT NULL,
  `member_id` VARCHAR(15) NOT NULL,
  PRIMARY KEY (`no`),
  INDEX `fk_star_location_baseaddress1_idx` (`baseaddress_no` ASC) VISIBLE,
  INDEX `fk_star_location_member1_idx` (`member_id` ASC) VISIBLE,
  CONSTRAINT `fk_star_location_baseaddress1`
    FOREIGN KEY (`baseaddress_no`)
    REFERENCES `happyhouse`.`baseaddress` (`no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_star_location_member1`
